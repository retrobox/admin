        ...
        methods: {
            ...
            fetchData: function(){
                this.$apitator.query(this, {
                    body: {
                      query:`query($id: String!){getOneShopCategory(id: $id){id,locale,title,is_customizable}}`,
                      variables: {
            ...
            submit () {
              ...
              if (!this.$v.$invalid) {
                  this.$apitator.query(this, {
                      body: {
                        query:`mutation($category: ShopCategoryUpdateInput!){updateShopCategory(category: $category)}`,
                        variables: {
                          category: {
                            id: this.$route.params.id,
                            title: this.name,
